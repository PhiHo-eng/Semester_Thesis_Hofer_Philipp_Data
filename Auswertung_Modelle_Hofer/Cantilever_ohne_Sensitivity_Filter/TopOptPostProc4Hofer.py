...
meshFig.name = "TopOpt_ohne_sens_filter_iso"
meshFig.vtkFolder = "."    # in this folder
meshFig.vtkFile = "ohne_sens_filter.vtu"
...
meshFig.name = "TopOpt_ohne_sens_filter_iso2"
meshFig.view =  (1, -1, 1)
meshFig.make()

meshFig.name = "TopOpt_ohne_sens_filter_iso3"
meshFig.view =  (-1, -1, 1)
meshFig.make()
...
meshFig.name = "TTopOpt_ohne_sens_filter_side1"
meshFig.view =  (1, 0, 0)
meshFig.make()

meshFig.name = "TopOpt_ohne_sens_filter_side2"
meshFig.view =  (0, 1, 0)
meshFig.make()

meshFig.name = "TopOpt_ohne_sens_filter_top"
meshFig.view =  (0, 0, 1)
meshFig.make()
...
meshFig = VisualizeMesh()
meshFig.name = "TopOpt_ohne_sens_filter_WireFrame_iso"
meshFig.vtkFolder = "."    # in this folder
meshFig.vtkFile = "ohne_sens_filter.vtu"
meshFig.showPlot = ShowPlot
...
densFig.vtkFile = "Ohne_sens_filter0018.vtu"
