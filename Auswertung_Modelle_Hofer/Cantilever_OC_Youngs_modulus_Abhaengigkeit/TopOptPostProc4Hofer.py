...
meshFig.vtkFile = "Canitlver_alter_filter.vtu"
...
meshFig.name = "TopOpt_Canitlver_alter_filter_iso2"
meshFig.view =  (1, -1, 1)
meshFig.make()

meshFig.name = "TopOpt_Canitlver_alter_filter_iso3"
meshFig.view =  (-1, -1, 1)
meshFig.make()

meshFig.name = "TopOpt_Canitlver_alter_filter_iso4"
meshFig.view =  (-1, 1, 1)
meshFig.make()


meshFig.name = "TopOpt_Canitlver_alter_filter_side1"
meshFig.view =  (1, 0, 0)
meshFig.make()

meshFig.name = "TopOpt_Canitlver_alter_filter_side2"
meshFig.view =  (0, 1, 0)
meshFig.make()

meshFig.name = "TopOpt_Canitlver_alter_filter_top"
meshFig.view =  (0, 0, 1)
meshFig.make()
...
meshFig = VisualizeMesh()
meshFig.name = "TopOpt_Canitlver_alter_filter_WireFrame_iso"
meshFig.vtkFolder = "."    # in this folder
meshFig.vtkFile = "Canitlver_alter_filter.vtu"
meshFig.showPlot = ShowPlot
...
densFig.name = "TopOpt_Canitlver_alter_filter_Dens_iso"
densFig.vtkFolder = "."    # in this folder
densFig.vtkFile = "alter_filter0024.vtu"
