...
meshFig.vtkFile = "Cantilever_05.vtu"
...
meshFig.name = "TopOpt_Cantilever_05_iso2"
meshFig.view =  (1, -1, 1)
meshFig.make()

meshFig.name = "TopOpt_Cantilever_05_iso3"
meshFig.view =  (-1, -1, 1)
meshFig.make()

meshFig.name = "TopOpt_Cantilever_05_iso4"
meshFig.view =  (-1, 1, 1)
meshFig.make()


meshFig.name = "TopOpt_Cantilever_05_side1"
meshFig.view =  (1, 0, 0)
meshFig.make()

meshFig.name = "TopOpt_Cantilever_05_side2"
meshFig.view =  (0, 1, 0)
meshFig.make()

meshFig.name = "TopOpt_VCantilever_05_top"
meshFig.view =  (0, 0, 1)
meshFig.make()
...
meshFig = VisualizeMesh()
meshFig.name = "TopOpt_Cantilever_05_WireFrame_iso"
meshFig.vtkFolder = "."    # in this folder
meshFig.vtkFile = "Cantilever_05.vtu"
meshFig.showPlot = ShowPlot
...
densFig.name = "TopOpt_Cantilever_05_Dens_iso"
densFig.vtkFolder = "."    # in this folder
densFig.vtkFile = "Cantilever_050026.vtu"
