...
meshFig.vtkFile = "Seilbahnmast_OC_render.vtu"
...
meshFig.name = "TopOpt_Seilbahnmast_OC_ganz_iso2"
meshFig.view =  (1, -1, 1)
meshFig.make()

meshFig.name = "TopOpt_Seilbahnmast_OC_ganz_iso3"
meshFig.view =  (-1, -1, 1)
meshFig.make()

meshFig.name = "TopOpt_Seilbahnmast_OC_ganz_iso4"
meshFig.view =  (-1, 1, 1)
meshFig.make()


meshFig.name = "TopOpt_Seilbahnmast_OC_ganz_side1"
meshFig.view =  (1, 0, 0)
meshFig.make()

meshFig.name = "TopOpt_Seilbahnmast_OC_ganz_side2"
meshFig.view =  (0, 1, 0)
meshFig.make()

meshFig.name = "TopOpt_Seilbahnmast_OC_ganz_top"
meshFig.view =  (0, 0, 1)
meshFig.make()
...
meshFig = VisualizeMesh()
meshFig.name = "TopOpt_Seilbahnmast_OC_ganz_WireFrame_iso"
meshFig.vtkFolder = "."    # in this folder
meshFig.vtkFile = "Seilbahnmast_OC_render.vtu"
meshFig.showPlot = ShowPlot
...
densFig.name = "TopOpt_Seilbahnmast_OC_ganz_Dens_iso"
densFig.vtkFolder = "."    # in this folder
densFig.vtkFile = "Seilbahnmast_OC_density.vtu"
