...
meshFig.vtkFile = "MMA_vtk_model.vtu"
...
meshFig.name = "TopOpt_MMA_iso2"
meshFig.view =  (1, -1, 1)
meshFig.make()

meshFig.name = "TopOpt_MMA_iso3"
meshFig.view =  (-1, -1, 1)
meshFig.make()

meshFig.name = "TopOpt_MMA_iso4"
meshFig.view =  (-1, 1, 1)
meshFig.make()


meshFig.name = "TopOpt_MMA_side1"
meshFig.view =  (1, 0, 0)
meshFig.make()

meshFig.name = "TopOpt_MMA_side2"
meshFig.view =  (0, 1, 0)
meshFig.make()

meshFig.name = "TopOpt_MMA_top"
meshFig.view =  (0, 0, 1)
meshFig.make()
...
meshFig = VisualizeMesh()
meshFig.name = "TopOpt_MMA_WireFrame_iso"
meshFig.vtkFolder = "."    # in this folder
meshFig.vtkFile = "MMA_vtk_model.vtu"
meshFig.showPlot = ShowPlot
...
densFig.name = "TopOpt_MMA_Dens_iso"
densFig.vtkFolder = "."    # in this folder
densFig.vtkFile = "MMA_vtk0033.vtu"
