...
meshFig.vtkFile = "Ganzes_model_gerendert.vtu"
...
meshFig.name = "TopOpt_MMA_Ganzes_model_iso2"
meshFig.view =  (1, -1, 1)
meshFig.make()

meshFig.name = "TopOpt_MMA_Ganzes_model_iso3"
meshFig.view =  (-1, -1, 1)
meshFig.make()

meshFig.name = "TopOpt_MMA_Ganzes_model_iso4"
meshFig.view =  (-1, 1, 1)
meshFig.make()


meshFig.name = "TopOpt_MMA_Ganzes_model_side1"
meshFig.view =  (1, 0, 0)
meshFig.make()

meshFig.name = "TopOpt_MMA_Ganzes_model_side2"
meshFig.view =  (0, 1, 0)
meshFig.make()

meshFig.name = "TopOpt_MMA_Ganzes_model_top"
meshFig.view =  (0, 0, 1)
meshFig.make()
...
meshFig = VisualizeMesh()
meshFig.name = "TopOpt_MMA_Ganzes_model_WireFrame_iso"
meshFig.vtkFolder = "."    # in this folder
meshFig.vtkFile = "Ganzes_model_gerendert.vtu"
meshFig.showPlot = ShowPlot
...
densFig.name = "TopOpt_MMA_Ganzes_model_Dens_iso"
densFig.vtkFolder = "."    # in this folder
densFig.vtkFile = "Ganzes_model_seilbahnmast_density.vtu"
