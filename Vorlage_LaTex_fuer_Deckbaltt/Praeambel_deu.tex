...
\renewcommand{\nomgroup}[1]{%
	...
	\ifthenelse{\equal{#1}{I}}{\vspace{16pt} \item[\textbf{Indizes und Akzente}]}{%
	\ifthenelse{\equal{#1}{G}}{\vspace{16pt} \item[\textbf{Griechische Symbole}]}{%
	\ifthenelse{\equal{#1}{L}}{\vspace{16pt} \item[\textbf{Lateinische Symbole}]}}}}
...
\renewcommand{\sectionmark}[1]{\markright{\thechapter~ #1}}
  ...
  \fancyfoot[L]{\small{Lehrstuhl für Luftfahrtsysteme $\quad |\quad$  Technische Universität München}}
